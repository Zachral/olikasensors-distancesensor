...
#define FRONT_ULTRASONIC_TRIGGER   4              /*need to configure trigger pin(0-7) */
#define FRONT_ULTRASONIC_ECHO      5
#define RIGHT_ULTRASONIC_TRIGGER   6               /*need to configure trigger pin(0-7) */
#define RIGHT_ULTRASONIC_ECHO      7    
